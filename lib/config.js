...
export const AGENDA_MANYCHAT_FIELD_CANDIDATO_CORREO = 14931774;
...
// MENSAJES — creación de vacantes por WhatsApp: números autorizados a usar este
// flujo interno (reclutadoras); cualquier otro número sigue el flujo normal de postulación
export const NUMEROS_AUTORIZADOS_VACANTES = ['5213323100053'];
// Plantilla "Plantilla para vacantes administrativas" en TeamTailor (GET /jobs?filter[status]=template)
export const TEAMTAILOR_TEMPLATE_ID_VACANTE = '129919';
