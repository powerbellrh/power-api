...
// DigitalOcean es el proveedor más rápido para deepseek-v4-flash-0731 (por eso el sort
// por latencia casi siempre lo elige), pero devuelve output corrupto con más frecuencia
// que los demás; se excluye por default para no depender solo de los reintentos.
const PROVEEDORES_EXCLUIDOS_DEFAULT = ['digitalocean'];
